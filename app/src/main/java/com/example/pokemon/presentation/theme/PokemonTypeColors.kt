...
/** Colores clásicos por tipo de Pokémon, usados en los chips de la pantalla de detalle. */
object PokemonTypeColors {
    ...
    fun colorFor(type: String): Color = colors[type.lowercase()] ?: Color(0xFF68A090)
}
